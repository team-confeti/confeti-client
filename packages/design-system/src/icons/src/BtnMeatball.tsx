...
interface BtnMeatballProps extends SVGProps<SVGSVGElement> {
  isDropdownOpen?: boolean;
}

const SvgBtnMeatball = ({ isDropdownOpen, ...props }: BtnMeatballProps) => (
  <svg
  ...
  >
    ...
    <rect
      ...
      x={0.5}
      y={0.5}
      stroke={isDropdownOpen ? '#92C015' : '#EFF0F4'}
      rx={4.5}
    />
