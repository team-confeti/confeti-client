...
const SvgCheckboxFestivalActive = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <rect width={21} height={21} x={0.5} y={0.5} fill="#B5F602" rx={10.5} />
    <rect width={21} height={21} x={0.5} y={0.5} stroke="#212224" rx={10.5} />
    <path
      fill="#212224"
...
export default SvgCheckboxFestivalActive;
