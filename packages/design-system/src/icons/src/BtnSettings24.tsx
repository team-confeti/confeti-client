...
const SvgBtnSettings24 = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#btn_settings_24_svg__a)">
      <path
        fill="#121212"
    ...
    <defs>
      <clipPath id="btn_settings_24_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgBtnSettings24;
