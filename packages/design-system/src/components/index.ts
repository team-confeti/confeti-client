...
export { default as BottomNavigation } from './bottom-navigation/bottom-navigation';
...
export { default as NumberIndicator } from './indicator/number-indicator/number-indicator';
