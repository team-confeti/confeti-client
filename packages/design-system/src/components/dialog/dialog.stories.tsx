    ...
    docs: {
      description: {
        component:
          ...
          '1. **Root**: 다이얼로그의 기본 컨테이너로, 백드롭과 모달 창을 관리합니다. `open` 속성을 통해 표시 여부를 제어하고, `backDrop` 속성으로 배경 오버레이를 설정할 수 있습니다. \n\n' +
          '2. **Content**: 다이얼로그 내용을 감싸는 컨테이너로, 제목과 설명 텍스트를 적절히 배치합니다. \n\n' +
          '3. **Title**: 다이얼로그의 제목을 표시하는 요소로, 주요 목적이나 메시지를 간결하게 전달합니다. \n\n' +
          '4. **Description**: 다이얼로그의 상세 내용이나 부가 설명을 제공하는 텍스트 요소입니다. \n\n' +
          '5. **Action**: 다이얼로그 하단에 위치한 버튼 영역으로, 돌아가기, 탈퇴/로그아웃 등의 사용자 응답을 처리합니다. \n\n' +
